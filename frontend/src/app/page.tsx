...
export default function HomePage() {
  ...
  return (
    <PageReveal>
      <section id="home" className="overflow-hidden pb-20 pt-12 md:pt-16">
            ...
            <form onSubmit={handleContactSubmit} className="glass-panel p-6 md:p-8">
              <div className="grid gap-5 md:grid-cols-2">
                <div className="form-field">
                  ...
                  <input id="home-name" type="text" name="fullName" placeholder="Your full name" className="form-control rounded-2xl border border-moonBorder/70 bg-moonSoft/60 text-moonInk outline-none focus:border-moonGreen focus:ring-2 focus:ring-moonGreen/30" required />
                </div>
                <div className="form-field">
                  <label htmlFor="home-email" className="form-label">Email</label>
                  <input id="home-email" type="email" name="email" placeholder="you@example.com" className="form-control rounded-2xl border border-moonBorder/70 bg-moonSoft/60 text-moonInk outline-none focus:border-moonGreen focus:ring-2 focus:ring-moonGreen/30" required />
                </div>
                <div className="form-field md:col-span-2">
                  <label htmlFor="home-company" className="form-label">Company / Organization</label>
                  <input id="home-company" type="text" name="company" placeholder="Your company or organization" className="form-control rounded-2xl border border-moonBorder/70 bg-moonSoft/60 text-moonInk outline-none focus:border-moonGreen focus:ring-2 focus:ring-moonGreen/30" />
                </div>
                <div className="form-field md:col-span-2">
                  <label htmlFor="home-message" className="form-label">Project details</label>
                  <textarea id="home-message" name="message" placeholder="Tell us about your website or software project" className="form-control rounded-2xl border border-moonBorder/70 bg-moonSoft/60 text-moonInk outline-none focus:border-moonGreen focus:ring-2 focus:ring-moonGreen/30" required />
                </div>
              </div>
