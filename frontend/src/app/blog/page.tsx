...
export const metadata: Metadata = {
  title: "News & Events",
  description: "Latest news, events, and technology guidance from MIZYRA Institute of Technology."
};
    ...
    <PageReveal>
      <section className="page-hero section-shell">
        <SectionHeading
          ...
          description="Explore career guidance, institute updates, and practical notes from engineering, research, and digital product work."
        />
